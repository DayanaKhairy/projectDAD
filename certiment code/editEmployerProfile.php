        ...
        if ($stmt->execute()) {
            ...
            echo '<script>
                    if (confirm("File uploaded successfully.")) {
                        window.location.href = "profileEmp.php";
                    }
                  </script>';
        } else {
            echo '<script>
    ...
    <div class="form-container">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="profile-picture">
                <img src="profile/<?php echo $_SESSION['user_pic']; ?>" alt="Profile Picture">
            </div>
            ...
            <input type="text" name="phoneNo" value="<?php echo $_SESSION['user_phoneNo']; ?>" required>

            <label for="position">Current Position:</label>
            <input type="text" name="position" value="<?php echo $_SESSION['user_position']; ?>" required>
